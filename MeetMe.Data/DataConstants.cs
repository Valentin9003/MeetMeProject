...
namespace MeetMe.Data
{
    ...
    {
        public const string CommentValueMaxLengthErrorMessage = "Comment can't be longer than 50 characters.";
        ...
        public const string UserCountryMaxLengthErrorMessage = "The field COUNTRY can't be longer than 30 characters.";
        public const string UserCityMaxLengthErrorMessage = "The filed CITY can't be longer than 20 characters.";
