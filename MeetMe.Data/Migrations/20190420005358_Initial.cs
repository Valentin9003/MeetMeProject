        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Weight = table.Column<int>(maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Friends", x => new { x.UserId, x.ContactId });
                    table.ForeignKey(
                        name: "FK_Friends_AspNetUsers_ContactId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnreadOrRead = table.Column<bool>(nullable: false),
                    TimeOfSend = table.Column<DateTime>(nullable: false),
                    TimeOfSeen = table.Column<DateTime>(nullable: false),
                    SenderId = table.Column<string>(nullable: false),
                    RecievedId = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Messages", x => x.MessagesId);
                    table.UniqueConstraint("AK_Messages_SenderId_RecievedId", x => new { x.SenderId, x.RecievedId });
                    table.ForeignKey(
                        name: "FK_Messages_AspNetUsers_RecievedId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(nullable: false),
                    WritingТime = table.Column<DateTime>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_Picture_PictureId",
                        column: x => x.PictureId,
                        principalTable: "Picture",
                        principalColumn: "PictureId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Comments_ProfilePicture_ProfilePictureId",
                        column: x => x.ProfilePictureId,
                        principalTable: "ProfilePicture",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NotificationТime = table.Column<DateTime>(nullable: false),
                    informationForNotification = table.Column<string>(nullable: false),
                    UserId = table.Column<string>(nullable: true),
